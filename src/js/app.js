...
const controller = (budgetCtrl, UICtrl) => {
    const setupEventListeners = () => {
        ...
        document.querySelector(base.container).addEventListener('click', ctrlDeleteItem);
        
        document.querySelector(base.inputType).addEventListener('change', budgetView.changedType);
    }
}

// change f. changedType!!! related to nodeList
